...
def create(args=None, **_):
    ...
    return Interface().created(args)


@operation
def delete(args=None, **_):
    """ Delete the Network Interface """
    return Interface().deleted(args)


@operation
def attach(args=None, **_):
    """ Attach the Network Interface """
    return InterfaceAttachment().attach(args)


@operation
def detach(args=None, **_):
    """ Dettach the Network Interface """
    return InterfaceAttachment().detach(args)
