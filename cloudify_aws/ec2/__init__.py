...
from cloudify_aws.common.utils import check_region_name, get_aws_config_from_sources
...
class EC2Base(AWSResourceBase):
    ...
    def __init__(self,
        ...
        if not client:
            aws_config, _ , __= get_aws_config_from_sources(
                ctx_node, node_prop_name=AWS_CONFIG_PROPERTY)
